      ...
      <nav class="navbar navbar-expand-lg bg-white ">
        <div class="container-fluid">
          <a href="?mod=page&act=home">
            <img src="../content/img/logo_pnj.png" alt="" style="width: 60px; cursor: pointer; margin:0 50px;">
          </a>
          ...
          <div class="collapse navbar-collapse " id="navbarTogglerDemo01">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link text-black" href="?mod=page&act=category&id=2">TRANG SỨC</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-black" href="?mod=page&act=category&id=1">ĐỒNG HỒ</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-black" href="?mod=page&act=category&id=3">QUÀ TẶNG</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-black" href="?mod=page&act=category&id=">BLOG</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-black" href="?mod=page&act=category&id=">KHUYẾN MÃI</a>
              </li>
            </ul>
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="../content/img/banner44.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="../content/img/banner11.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="../content/img/banner33.jpg" class="d-block w-100" alt="...">
      </div>
    </div>
