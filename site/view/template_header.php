      ...
      <nav class="navbar navbar-expand-lg bg-white ">
        <div class="container-fluid">
          <a href="?mod=page&act=home">
            <img src="../content/img/Thiết kế chưa có tên (1).png" alt="" style="width: 60px; cursor: pointer; margin:0 50px;">
          </a>
          ...
          <div class="collapse navbar-collapse " id="navbarTogglerDemo01">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link text-black" href="?mod=page&act=category&id=2">ÁO NAM</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-black" href="?mod=page&act=category&id=1">VÁY NỮ</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-black" href="?mod=page&act=category&id=3">TRẺ EM</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-black" href="?mod=page&act=category&id=">ƯU ĐÃI 35%</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-black" href="?mod=page&act=category&id=">CỬA HÀNG</a>
              </li>
            </ul>
